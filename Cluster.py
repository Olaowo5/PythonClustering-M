...
#now looking at the corellation nbetween all the audio features in the dataset
print(data.corr())

#Now I will use the K-means clustering algorithm to find the 
# similarities between all the audio features
...
#Now I will add the clusters as predicted by the K-means 
# clustering algorithm to the original dataset:
